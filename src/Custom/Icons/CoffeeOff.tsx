...
interface CoffeeOffOutlinedIconProps {
...
const CoffeeOffOutlinedIcon: React.FC<CoffeeOffOutlinedIconProps> = ({
  fontSize,
  color,
  sx
}) => {
  return (
    <SvgIcon fontSize={fontSize} color={color} sx={sx}>
...
export default CoffeeOffOutlinedIcon;
